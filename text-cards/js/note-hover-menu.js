(function initTextCardsNoteHoverMenu(global) {
  ...
  function create(options) {
    ...
    menu.innerHTML = `
      <button type="button" class="w-full cursor-pointer border-0 bg-transparent px-2.5 py-2 text-left text-[13px] text-slate-300 transition-colors hover:bg-slate-800 hover:text-slate-50" data-action="edit">编辑</button>
      <button type="button" class="w-full cursor-pointer border-0 bg-transparent px-2.5 py-2 text-left text-[13px] text-slate-300 transition-colors hover:bg-slate-800 hover:text-slate-50" data-action="copy">复制</button>
      <button type="button" class="w-full cursor-pointer border-0 bg-transparent px-2.5 py-2 text-left text-[13px] text-red-400 transition-colors hover:bg-red-500/10 hover:text-red-300" data-action="delete">删除</button>
    `;
