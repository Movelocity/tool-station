...
A personal collection of browser-based utilities — each a single, self-contained page.
...
This is a station for that kind of tool.

## Tools

| Tool | Description |
|------|-------------|
| **Image Process** | Crop, resize, and process images |
| **JWT** | Decode and inspect JWT tokens |
| **QR Reader** | Scan and decode QR codes |
| **Rocket Simulator** | Physics-based rocket simulator |
| **JSON Canvas** | Visualize JSON as a canvas |
